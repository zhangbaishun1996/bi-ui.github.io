//效果....
var mcond1_n1=0,mcond1_n2=0,mcond1_n3=0,mcond1_n4=0,mcond1_n5=0,mcond1_n6=0;
function effectMcond1(n1,n2,n3,n4,n5,n6){
	if(n1!=null){ mcond1_n1=n1; }
	if(n2!=null){ mcond1_n2=n2; }
	if(n3!=null){ mcond1_n3=n3; }
	if(n4!=null){ mcond1_n4=n4; }
	if(n5!=null){ mcond1_n5=n5; }
	if(n6!=null){ mcond1_n6=n6; }
	...
	$('#odometer_base1').html(mcond1_n1);
	$('#odometer_base2').html(mcond1_n2);
	$('#odometer_base3').html(mcond1_n3);
	$('#odometer_base4').html(mcn4);
	$('#odometer_base5').html(mcn5);
	$('#odometer_base6').html(mcond1_n6);
}
