//近一周收入汇总
var chargeBarPnameArray=["03-12", "03-13", "03-14", "03-15", "03-16", "03-17", "03-18"];
var chargeBarMoneyDataArray=["93656.14","92662.11","80706.17","99694.12","94055.10","96665.00","51586.03"];
...
function showCharts_Charge_bar(dateArray, moneyDataArray, unitTag){
	...
	if(chargeBarPnameArray==null || chargeBarMoneyDataArray==null){ return; }
	if(unitTag==null){ unitTag="元"; }
